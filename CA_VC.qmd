...
The results show the accuracy and the log loss of this first iteration of the model. When testing this model, adding the logarithmic step created the most noticeable change in log loss, the metric used to judge each model. Other models 
