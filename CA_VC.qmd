...
A K-nearest neighbors model, or KNN for short, estimates new predictions based on the status of other observations nearest to it.  
...
The results show the accuracy and the log loss of this first iteration of the model. When testing this model 
