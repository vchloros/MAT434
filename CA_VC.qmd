...
This next step takes our workflow and applies it to training folds created earlier. These folds are equally-sized samples of the data used for cross-validation. 
